...
public class PotionList {
    ...
    public static List<Potion> getPotionList() {
        ...
        Potion potion5 = new Potion("0",false);
        ...
        potion5.setCoef(2);
        potion5.setpowerPercentage(0.05);
        potion5.setPermanent(true);
        potionList.add(potion5);

        Potion potion10 = new Potion("1",false);
        ...
        potion10.setCoef(10);
        potion10.setpowerPercentage(0.1);
        potion10.setPermanent(true);
        potionList.add(potion10);

        Potion potion20 = new Potion("2",false);
        ...
        potion20.setpowerPercentage(0.2);
        potion20.setPermanent(false);
        potionList.add(potion20);

        Potion potion40 = new Potion("3",false);
        potion40.setequipmentType(EquipmentTypes.POTION);
        potion40.setType(PotionTypes.ELIXIR_OF_ETERNAL_POWER);
