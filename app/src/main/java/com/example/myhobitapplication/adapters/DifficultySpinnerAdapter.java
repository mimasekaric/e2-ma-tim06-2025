...
public class DifficultySpinnerAdapter extends ArrayAdapter<Integer> {
    ...
    public DifficultySpinnerAdapter(Context context) {
        ...
        List<Integer> difficulties = new ArrayList<>(Arrays.asList(1, 3, 7, 20));
        this.addAll(difficulties);
    }
    ...
    private View createCustomView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.spinner_item_difficulty, parent, false);
        }
